      ...
      <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
          <div class="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
              <div class="flex items-center flex-1 space-x-4">
                  <h5>
                      <span class="dark:text-black">{{ __('ventas.prdocuts_of_proposal') }} {{$venta->id}} {{ __('ventas.of_customer') }} {{$venta->cliente->Nombre}}</span>
                  </h5>
              </div>
              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                      <tr>
                          ...
                          <th scope="col" class="px-4 py-3">{{ __('ventas.unit_price') }}</th>
    ...
    @endphp
                      <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                          ...
                          <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                           ...
                           @endforeach
                           <tr>
    <td colspan="3" class="text-gray-900" style="text-align: right;"><strong>{{ __('ventas.total') }}</strong></td>
    <td style="padding-left: 53px;" class="text-gray-900">
